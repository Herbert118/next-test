...
var home_module_css_1 = require("./ui/home.module.css");
var link_1 = require("next/link");
var fonts_1 = require("@/app/ui/fonts");
var image_1 = require("next/image");
function Page() {
    return (React.createElement("main", { className: "flex min-h-screen flex-col p-6" },
        React.createElement("div", { className: "h-0 w-0 border-b-[30px] border-l-[20px] border-r-[20px] border-b-black border-l-transparent border-r-transparent" }),
        ...
        React.createElement("div", { className: "mt-4 flex grow flex-col gap-4 md:flex-row" },
            ...
            React.createElement("div", { className: "flex items-center justify-center p-6 md:w-3/5 md:px-28 md:py-12" },
                ...
                React.createElement(image_1["default"], { src: "/hero-mobile.png", width: 560, height: 720, className: "block md:hidden", alt: "Screenshots of the dashboard project showing desktop and mobile versions" })))));
}
